...
def main(argv=None):
    ...
    parser.add_argument("--compute-units", choices=("cpu_ne", "cpu_gpu", "cpu", "all"))
    ...
    if saved:
        ...
        args.compute_units = saved["settings"].get("compute_units")
    ...
    policy = LayaPolicy(args.model, prompt=args.prompt, compute_units=args.compute_units)
